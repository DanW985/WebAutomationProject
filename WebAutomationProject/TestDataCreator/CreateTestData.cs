...
namespace WebAutomationProject.TestDataCreator
{
    class CreateTestData
    {
        public string createEmailAddress()
        {
            ...
            string rdmLetters = randomLetters(5, true);
            string emailAddress = rdmLetters.Insert(5, emailDomain);
            return emailAddress.ToString();
        }

        public string randomLetters(int size, bool lowerCase)
        {
            ...
            {
                ch = Convert.ToChar(Convert.ToInt32(Math.Floor(26 * rdm.NextDouble() + 65)));
                builder.Append(ch);
            }
            if (lowerCase)
        ...
        public string GenRandomTelNo()
        {
            ...
            telNo = telNo.Append("-");
            number = rdm.Next(0, 743);
            telNo = telNo.Append(String.Format("{0:D3}", number));
            telNo = telNo.Append("-");
            number = rdm.Next(0, 10000);
